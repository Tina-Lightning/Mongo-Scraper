  ...
  $.getJSON("/saved", function(data) {
    for (var i = 0; i < data.length; i++) {
        ...
        newDeleteButton.text("Delete Article")
        newDeleteButton.attr("data-id", data[i]._id);
        newDeleteButton.attr("id", "deletearticle");
        newDeleteButton.addClass("btn btn-danger");
        newColRight.append(newDeleteButton);        
